            ...
            >
                ...
                <Modal.Body>
                    <form className="container" name="audioForm" onSubmit={handleSubmit} >
                        ...
                        <div className="form-group">
                            <h6>簡介</h6>
                            <textarea className="form-control" rows="2" name="audio_content_snippet" />
                        </div>
                        <div className="form-group">
                            <h6>內容介紹</h6>
                            <textarea className="form-control" rows="5" name="audio_content" />
                        </div>
                        <div className="form-group">
                            <h6>選擇音檔</h6>
...
export default withRouter(connect(mapStateToProps, { addAudioAsync, initalAudioListAsync })(AudioAddModal));
